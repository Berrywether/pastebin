...
API Documentation:
	...
	Trending pastes seems to be disbaled (not sure currently)
'''
...
class PasteBin:
	...
	def api_call(self, method, params):
		response = requests.post('https://pastebin.com/api/' + method, params, timeout=10)
	...
	def paste(self, data, guest=False, name=None, format=None, private=None, expire=None, folder=None):
		...
		if folder    : params['api_folder_key']        = folder
